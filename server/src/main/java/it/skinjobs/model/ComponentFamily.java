...
public class ComponentFamily {
   ...
   /**
     * This decorator allows us to realize a many to one relationship between the ComponentType's primary key(id) and
     * each table referencing it with a foreign key, in this case type_id is a foreign key for ComponentType's id
     */
   @ManyToOne
